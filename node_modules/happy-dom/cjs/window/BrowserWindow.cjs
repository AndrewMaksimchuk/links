...
class BrowserWindow extends EventTarget_js_1.default {
    ...
    NamedNodeMap = NamedNodeMap_js_1.default;
    TreeWalker = TreeWalker_js_1.default;
    NodeIterator = NodeIterator_js_1.default;
    DataTransfer = DataTransfer_js_1.default;
    DataTransferItem = DataTransferItem_js_1.default;
    DataTransferItemList = DataTransferItemList_js_1.default;
    Headers = Headers_js_1.default;
    XMLSerializer = XMLSerializer_js_1.default;
    ClipboardItem = ClipboardItem_js_1.default;
    Selection = Selection_js_1.default;
    CSSUnitValue = CSSUnitValue_js_1.default;
